...
public class Inventory {
   ...
   */
  private List<Guitar> refinedSearch (Collection<Guitar> coll,
                                      GuitarSpecification ideal) {
   ...
   */
  public List<Guitar> search (Collection<Guitar> coll,
                              GuitarSpecification ideal) {
   ...
   */
  public List<Guitar> search (GuitarSpecification ideal) {
  ...
  public void replace (int serialNo, String field,
    ...
    if (!stock.containsKey (serialNo))
      throw new NoSuchElementException (String.format ("Guitar #%d is not in stock.",
                                        serialNo));
    Guitar g = stock.get (serialNo);
