...
public class Main {
  ...
  private static void jdi() {
    ...
    gs = GuitarSpecification.builder().withBrand ("Yamaha").withModel ("adads").withSoundType ("acoustic").withWood ("cedar",
         "alder").build();
    inv.addToCollection (new Guitar (gs));
    gs = GuitarSpecification.builder().withBrand ("Fender").withModel ("cxzv").withSoundType ("electric").withWood ("rosewood",
         "mahogany").build();
    inv.addToCollection (new Guitar (gs));
    gs = GuitarSpecification.builder().withBrand ("Paul Reed Smith").withModel ("qwewq").withSoundType ("electric").withWood ("cedar",
         "mahogany").build();
    inv.addToCollection (new Guitar (gs));
  }
